...
const RandomNoiseBlend = () => {
  ...
  return (
    <>
      ...
      <mesh rotation={[c.x.value, c.y.value, c.z.value]} ref={tetrahedronRef}>
        <octahedronGeometry args={[3, 0]}  />
        {c.normal ? (
          <meshNormalMaterial />
        ) : (
          <meshBasicMaterial color="rgb(255,24,24)" />
        )}
      </mesh>
...
const Scene = ({className}:{className:string}) => <Canvas className={className}><RandomNoiseBlend/></Canvas>
